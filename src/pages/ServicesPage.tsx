      ...
      <section className="relative h-[75vh] flex items-start justify-center overflow-hidden">
        ...
        <div className="container relative z-10 px-6 max-w-[1000px] text-center pt-40">
          ...
          <motion.h1
            ...
            className="font-display font-bold text-4xl md:text-7xl lg:text-8xl tracking-tight md:tracking-tighter mb-8 bg-clip-text text-transparent bg-gradient-to-b from-foreground to-foreground/50 break-words"
          >
