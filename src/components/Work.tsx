  ...
  return (
    ...
    >
      <div className="relative w-full h-full overflow-hidden rounded-2xl md:rounded-[2rem] shadow-2xl bg-card">
        ...
        {/* Project Name Badge Overlay */}
        <div className="absolute top-6 left-6 md:top-8 md:left-8 z-30">
          <Badge className="bg-white/95 text-black hover:bg-white px-4 py-2 text-sm md:text-base font-semibold rounded-full shadow-lg backdrop-blur-sm">
            {project.title}
          </Badge>
        </div>
