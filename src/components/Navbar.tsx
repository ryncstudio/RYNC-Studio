...
export function Navbar() {
  ...
  const isActive = (href: string) => {
    ...
    if (href === "/work" && location.startsWith("/work")) return true;
    ...
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4">
      ...
      >
        ...
        <Link href="/" className="group relative z-50">
          <span className="font-display font-bold text-2xl tracking-tighter bg-clip-text text-transparent bg-gradient-to-r from-foreground to-foreground/90 group-hover:to-primary transition-all">
